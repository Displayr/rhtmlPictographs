#This file is auto generated from /bugs_and_improvements/improvement_support_proportion_in_string.html
...
##Current
##Improved Syntax:
rhtmlPictographs::graphic('{ "variableImage": "circle:radial:lightblue", "proportion" : 0.7 }')
